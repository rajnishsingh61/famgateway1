...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "ZapGateway" },
...
const ADSENSE_SRC =
  "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9464901744553188";

function RootComponent() {
  const { queryClient } = Route.useRouteContext();

  // Loaded after hydration: AdSense injects DOM nodes that break SSR hydration.
  useEffect(() => {
